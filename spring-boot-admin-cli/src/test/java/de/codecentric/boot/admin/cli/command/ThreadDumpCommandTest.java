...
public class ThreadDumpCommandTest {
	@Rule
	...
	private ThreadDumpCommand cmd = new ThreadDumpCommand();

	@Test
	public void run() throws Exception {
		stubFor(get(urlMatching("/api/applications/.*/dump")).willReturn(aResponse()
